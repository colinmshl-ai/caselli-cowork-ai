  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center px-4">
      ...
      <div className="pt-8 pb-6">
        <span className="text-base text-foreground tracking-tight"><span className="font-serif italic font-semibold">Caselli</span> <span className="font-sans font-light">Cowork</span></span>
      </div>
